...
目标不是“400 篇都存在”，而是逐步把 400 篇推成 S 级，再把最强题推成 S+。

| Pack ID | Current Level | Target Level | Missing Evidence | Missing Product Entry | Missing Real Feedback | Next Action |
|---|---|---|---|---|---|---|
| 问题281 | S | S+ | CDC 数据源差异与 AI 诊断偏差已写入正文 | AI诊断边界卡 | 待真实发布 | 证据增强已写入，下一步看发布回流 |
| 问题350 | S | S+ | JAN + Microsoft 组织案例已写入正文 | 组织接口审计表 | 待真实发布 | 证据增强已写入，下一步看发布回流 |
| 问题392 | A | S | NIMH + CDC 诊断边界已写入正文 | 误诊漏诊边界清单 | 待真实发布 | 证据增强已写入，下一步看发布回流 |
| 问题400 | S | S+ | Microsoft 神经多样性组织案例已写入正文 | 产业断裂审计表 | 待真实发布 | 证据增强已写入，下一步看发布回流 |
| 问题375 | S | S+ | EEOC adverse impact 框架待人工核验后写入正文；Microsoft + JAN 可补 AI 招聘流程筛除证据链 | AI招聘筛除风险自查表 | 待真实发布 | 发布前重写第一屏，把“AI 招聘把旧偏差自动化”前置 |
| 问题377 | A | S+ | EEOC + Microsoft + JAN 可形成 AI治理岗/异常识别岗的神经多样性证据链 | 神经多样性岗位面试 accommodation checklist | 待真实发布 | 从 A 升 S 的首选候选，发布前补“招聘接口如何误读非典型优势”段落 |
| 问题390 | S | S+ | EEOC + JAN 可支撑“AI同事帮助还是监控”的职场边界；加入数字化合理便利框架 | AI协作/监控边界说明书 | 待真实发布 | 补算法治理和合理便利双证据后再发布 |
| 问题394 | S | S+ | NIMH + Akili 可支撑“工具帮到我不等于治疗 ADHD”的边界证据 | AI工具承诺边界卡 | 待真实发布 | 发布前校准医疗承诺，避免把执行支架写成治疗神话 |
## 2026-06-25 Scout Upgrade Notes
