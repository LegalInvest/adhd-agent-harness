# 问题190：为什么 ADHD 的个人案例库比名人案例更值钱？名人证明可能性，普通人证明可复制路径

很多 ADHD 文章有两种死法：一种是只讲论文，像科普；一种是只讲感觉，像玄学。真正能让人相信的，是三层证据同时在场。

这类题适合做成系列支柱：它不一定是第一发主炮，但会决定整个系统能不能稳定复用。

这篇要处理的不是一个单点技巧，而是一个更底层的项目判断：名人案例鼓舞但距离太远。真正的需求是：收集普通读者的改造路径。

如果它不能被压成 读者案例库，它就还只是一个观点；只有变成入口，它才开始替 ADHD 大脑减负。
...
这就是为什么 为什么 ADHD 的个人案例库比名人案例更值钱？ 不是一个孤立问题。它是在问：你的内容有没有从“表达系统”升级成“执行系统”。
...
收集普通读者的改造路径。这句话不是运营口号，而是系统设计原则。
...
- 公众号版核心标题：为什么 ADHD 的个人案例库比名人案例更值钱？名人证明可能性，普通人证明可复制路径
- 小红书版钩子：名人案例鼓舞但距离太远，这不是小问题，是系统入口断了。
- 知乎回答问题：为什么 ADHD 的个人案例库比名人案例更值钱？
- 短视频前三秒：别再把名人案例鼓舞但距离太远当成小问题，它其实是系统入口断了。
