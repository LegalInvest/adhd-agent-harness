...
先说一个事实：We studied a sample of 50 adults with ADHD and 51 healthy comparison controls using the Barratt Impulsivity Scale Version 11 (BIS), and neuropsychological tasks, namely the Continuous Performance Task (CPT-II) and the Iowa Gambling Task (IGT)。
...
2. A chatbot prompt can offer tips and techniques for regulating emotions, helping users maintain a more balanced emotional state.
...
- [Impulsive behavior in adults with attention deficit/ hyperactivity disorder: Characterization of attentional, motor and cognitive impulsiveness](https://doi.org/10.1017/s1355617707070889) — 证据等级：低（GRADE）
