---
title: "用 AI 设计 ADHD 的理想一天"
subtitle: "基于个人数据的AI日程优化"
description: "基于个人数据的AI日程优化"
date: "2025-03-19"
category: "时间管理"
...
tags:
  ...
  - "优先级"
readingTime: 13
slug: "用-ai-设计-adhd-的理想一天"
topicId: "time-mgmt-008"
angle: "日程设计"
rank: 346
score: 6.75
sourceCount: 2
...
1. Therefore, I use ChatGPT to generate language output suggestions in order to speed up some of my mandatory tasks.
2. At this point in time, my prompt engineering skills — in combination with the workings of Cha
...
5. A chatbot prompt can help individuals sort through their daily tasks, determining which are most important and urgent.
...
*本文是「ADHD × AI」系列的第 346 篇，内容基于全网最新情报与研究自动整合生成，并持续迭代更新。*
