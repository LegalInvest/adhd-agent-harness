---
title: "用 AI 建立 ADHD 的晨间和晚间例行程序"
subtitle: "AI设计的渐进式日常例程"
description: "AI设计的渐进式日常例程"
date: "2025-04-03"
category: "时间管理"
...
tags:
  ...
  - "优先级"
readingTime: 8
slug: "用-ai-建立-adhd-的晨间和晚间例行程序"
topicId: "time-mgmt-012"
angle: "日常例程"
rank: 348
score: 6.75
sourceCount: 2
...
1. A chatbot prompt can help individuals sort through their daily tasks, determining which are most important and urgent.
2. - Example prompt: "Here is a list of tasks I need to complete today.
3. - Example prompt: "I have the following tasks to complete today.
4. This guidance can help individuals find motivation and tackle their tasks more effectively.
5. A chatbot prompt can assist users in breaking down tasks, reducing the sense of overwhelm and making it easier to get started.
...
*本文是「ADHD × AI」系列的第 348 篇，内容基于全网最新情报与研究自动整合生成，并持续迭代更新。*
