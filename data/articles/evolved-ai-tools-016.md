---
title: "ADHD 工作流：把 Goblin Tools 接入你的第二大脑"
subtitle: "用 Goblin Tools 搭建不会遗漏的任务系统"
description: "用 Goblin Tools 搭建不会遗漏的任务系统"
date: "2025-04-01"
category: "AI工具实战"
categoryId: "ai-tools"
...
tags:
  ...
  - "效率工具"
readingTime: 10
slug: "adhd-工作流把-goblin-tools-接入你的第二大脑"
topicId: "evolved-ai-tools-016"
angle: "工作流"
rank: 113
score: 7.07
sourceCount: 4
...
isEvolved: true
---
# ADHD 工作流：把 Goblin Tools 接入你的第二大脑

> 用 Goblin Tools 搭建不会遗漏的任务系统
...
- When aligned with evidence-based practices and implemented with teacher oversight, AI can meaningfully augment existing support for neurodiverse learners（来源：A Review of Artificial Intelligence-Based Educational ...）。
...
1. It is a neurodevelopmental condition that affects executive function: the brain’s ability to plan, prioritize, initiate tasks, manage working memory, and regulate attention.
2. Every task management app requires you to manually enter tasks.
3. Email is one of the worst offenders: a quick inbox check turns into 45 minutes because each new message triggers a new context switch.
4. ADHD executive dysfunction isn’t about trying harder—it’s about needing external executive function.
5. Executive functions are your brain’s management system—planning, prioritizing, organizing, initiating tasks, remembering commitments, managing time.
...
*本文是「ADHD × AI」系列的第 113 篇，内容基于全网最新情报与研究自动整合生成，并持续迭代更新。*
