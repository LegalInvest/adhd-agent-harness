...
2. Additionally, we will suggest more prompts to assist those with ADHD in various aspects of their lives.
3. A chatbot prompt can help individuals sort through their daily tasks, determining which are most important and urgent.
4. - Example prompt: "Here is a list of tasks I need to complete today.
5. - Example prompt: "I have the following tasks to complete today.
...
*本文是「ADHD × AI」系列的第 347 篇，内容基于全网最新情报与研究自动整合生成，并持续迭代更新。*
