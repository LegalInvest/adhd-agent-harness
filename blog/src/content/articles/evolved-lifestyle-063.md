---
title: "用 Habitica 建立 ADHD 友好的日常例程"
subtitle: "Habitica 如何把混乱的日常变成可执行系统"
description: "Habitica 如何把混乱的日常变成可执行系统"
date: "2025-03-16"
category: "生活方式"
...
tags:
  ...
  - "人际关系"
readingTime: 12
slug: "用-habitica-建立-adhd-友好的日常例程"
topicId: "evolved-lifestyle-063"
angle: "生活工具"
rank: 336
score: 6.77
sourceCount: 4
...
isEvolved: true
---
# 用 Habitica 建立 ADHD 友好的日常例程

> Habitica 如何把混乱的日常变成可执行系统
...
1. - Strategies for Staying on Task:- Staying focused and on-task can be particularly challenging for individuals with ADHD.
2. - Example prompt: "I struggle with staying focused on my tasks due to my ADHD.
3. A chatbot prompt can assist users in developing routines for various aspects of their lives, such as morning and evening routines, meal planning, or exercise regimens.
4. Can you suggest a morning and evening routine that will help me stay organized and focused throughout the day?"
5. - Example prompt: "I have trouble managing my emotions due to my ADHD.
...
*本文是「ADHD × AI」系列的第 336 篇，内容基于全网最新情报与研究自动整合生成，并持续迭代更新。*
