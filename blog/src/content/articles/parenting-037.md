...
2. ADHD researcher Brendan Mahan coined the term “wall of awful” to describe the emotional barrier that builds around tasks associated with past failure or overwhelm.
3. And it means that every email containing multiple action items is a trap, because the ADHD brain processes them sequentially and anything not acted on immediately has a high probability of being lost.
4. ADHD executive dysfunction isn’t about trying harder—it’s about needing external executive function.
5. ADHD involves impaired executive functions, which creates specific daily struggles:
...
*本文是「ADHD × AI」系列的第 321 篇，内容基于全网最新情报与研究自动整合生成，并持续迭代更新。*
